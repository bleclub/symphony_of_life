    ...
    {  
        //  echo "Username already exists!";  
			echo ("<SCRIPT LANGUAGE='JavaScript'>
					...
					window.location.href='http://".$_SERVER['SERVER_NAME']."/bangkokrising-reward/';
					</SCRIPT>");
	}  
    else  
    {   
        $strSQL2 = "INSERT INTO db_redeem (`redeem_id`, `redeem_firstname`, `redeem_lastname`, `redeem_email`, `redeem_phone`, `redeem_prize`, `redeem_status`, `winner_id`) VALUES ('', '".$_POST['first_name']."', '".$_POST['last_name']."', '".$_POST['email']."', '".$_POST['phone']."', '".$_POST['prize']."', '0', '".$_POST['winner_id']."');"; 
        $objQuery2 = mysqli_query($db_con, $strSQL2);  
        if($objQuery2){ 
			 	$strTo = "info@mahanakhon.com";
				$strSubject = "Test Send Email";
				$strHeader.= "MIME-Version: 1.0' . \r\n";
				$strHeader.= "Content-type: text/html; charset=utf-8\r\n"; 
				$strHeader.= "From: webmaster@mahanakhon.com";
				...
				if($flgSend)
				{
					header("Location: http://".$_SERVER['SERVER_NAME']."/bangkokrising-reward/thankyou");
				}
